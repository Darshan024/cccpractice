...
echo "<br>(2)<br>";
$members1 = array("Address" => "Mumbai", "No" => "96xxxxxx26");
print_r(array_merge($members1, array_merge($students, $members)));

$keys = array(1, 2, 3);
echo "<br>(3)<br>";
print_r(array_combine($students, $members));

echo "<br>(4)<br>";
$numbers = array_combine(range('w', 'z'), range(110, 113));
print_r($numbers);
...
$members2 = array("Name" => "Peter", "Age" => "Zajj", "Country" => "USA");
echo "<br>(14)Array Values <br>";
print_r(array_values($members2));
echo "<br>";
print_r(array_keys($members2,"USA"));
...
echo "<br><br>(19)Array sorting by keys in reverse order <br><br>";
krsort($members2);
print_r($members2);
echo "<br>";
krsort($students);
...
echo "<br>(27)Array Slice<br>";
$array_slice = ['a' => 'apple', 'b' => 'banana', 'c' => 'cherry', 'd' => 'date', 'e' => 'elderberry'];
print_r(array_slice($array_slice, 0, sizeof($array_slice),false));
// if the true is used then the keys are not change in the result array
echo "<br>";
print_r(array_slice($array_slice, 1, 3,false));

echo "<br>(28)Array Splice<br>";
